...
import ProfileImg from "../assets/images/Foto de perfil.jpeg";
...
import JessicaMainImg from "../assets/images/Perfil.png";
...
const Home = () => {
  //Text
  const firstTexts = ["Motion Designer", "Developer", "Freelancer"];
  const secondTexts = [
    "Freelancer",
    "Motion Designer",
      ...
      <div className="side-menu">
        <div className="profile-img-main">
          ...
          <div className="profile-media-icons-main fade_up">
            ...
            <Link to="https://www.behance.net/jacksonaugusto1" className="profile-media-icons">
        ...
        <section className="section-one overflow-hidden" id="home">
          <div className="row">
            <div className="col-xxl-6 col-lg-6">
              ...
              I am very grateful for your trust, quality is the flagship of my work.
              </p>
            ...
            <div className="col-xxl-6 col-lg-6 position-relative">
              ...
              <div className="worked-box">
                <p className="worked-more">Work carried out for major brands.</p>
