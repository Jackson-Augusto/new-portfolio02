...
import YoutubeVideoImg from "../assets/images/Uberlitch.png";
import YoutubeSvg from "../assets/images/svg/youtube-svg.svg";
import VimeoVideoImg from "../assets/images/Nivea.png";
import VimeoSvg from "../assets/images/svg/vimeo-svg.svg";
import SoundCloudImg from "../assets/images/TORREDOHEROI.png";
            ...
            <div className="second-row-portfolio youtube zoom_in">
              <div>
                ...
                >
                  ...
                  <div className="overlay">
                    <img
                     src={YoutubeSvg} alt="Youtube-svg" className="vimeo-icon"
                    />
                    <p className="overlay-text">Product launch</p>
                  </div>
                </div>
                <YouTubeModal
              ...
              <p className="Corporate">Uberlitch Lamps</p>
              <p className="Corporate-sub">Blender / After Effects</p>
            </div>
          </div>
          <div>
            <div>
              ...
              >
                ...
                <div className="overlay">
                  ...
                  <p className="overlay-text">Nivea Umidade Diaria</p>
                </div>
              </div>
              <VimeoModal
                isOpen={isModalOpen}
            ...
            <p className="Corporate zoom_in">Nivea Umidade Diaria</p>
            <p className="Corporate-sub zoom_in">Blender</p>
            <div>
              <div
              ...
              >
                <div className="image-container">
                  ...
                  <div className="overlay">
                    <img
                     src={VimeoSvg} alt="vimeo-svg"
                     className="vimeo-icon"
                    />
                    <p className="overlay-text">The Hero's Tower</p>
                  </div>
                </div>
                <p className="Corporate">The Hero's Tower</p>
                <p className="Corporate-sub">MAYA / AFTER EFFECTS</p>
              </div>
              <SoundCloudModal
